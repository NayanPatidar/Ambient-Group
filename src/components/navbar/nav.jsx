  ...
  return (
    <div className="navigation-bar">
      <div className="flex flex-row justify-between items-center mt-8 lg:ml-8 md:ml-8 ml-5 ">
        <div className="text-white text-2xl font-thin pl-1 cursor-pointer items-center self-center">
        ...
        <div className=" text-white mr-10">
          <ul className="flex flex-row space-x-4  lg:gap-8 md:gap-8 gap-4 items-center">
            <li className="">
              <a
                className="navTags"
                href="#"
