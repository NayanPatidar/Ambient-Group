...
export default function EnchartedPage() {
  ...
  return (
    ...
    >
      ...
      <div
        data-aos="fade-up"
        className=" EnchartedDescription flex flex-col justify-center p-10"
      >
        <h3 className=" describeEncharted lg:text-2xl md:text-2xl text-lg lg:w-7/12 md:w-7/12 w-full lg:pl-10 md:pl-10 ">
        ...
        >
          ...
          >
            <div
              data-aos="fade-up"
              className=" grid lg:grid-cols-3 md:grid-cols-3 grid-cols-2 gap-4 lg:w-8/12 md:w-8/12 w-full border border-black border-t-0 border-r-0 border-b-0 "
            >
