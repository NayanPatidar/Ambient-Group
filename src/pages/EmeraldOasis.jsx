...
export default function EmeraldOasisPage({
  ...
  return (
    <div
      className={`EmraldManorMain flex flex-col justify-center items-center bg-white z-1 absolute          
    ...
    >
      <div className=" EmraldBackground flex flex-col justify-between bg-cover bg-center h-screen w-full ">
        ...
        >
          <h2 className="titleLineUp font-thin  text-6xl">EMERALD OASIS</h2>
